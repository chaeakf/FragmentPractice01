...
//                    currentFarg가 FragmentOne 이다.

                    ((FragmentOne) currentFrag).chageTextMsg(act.textEdt.getText().toString());

                } else if(act.viewPager.getCurrentItem() == 1){
//                    currentFarg가 FragmentTwo 이다.

                }else if(act.viewPager.getCurrentItem() == 2){
//                    currentFarg가 FragmentThree 이다.
                }
